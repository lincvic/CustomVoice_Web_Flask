...
import requests
from custom_voice_Config import URL, HOST_NAME, SUB_KEY, ENCODE_TYPE, GUID
...
def creatRequest(ssml):
    ...
    with open("static/audio/output.wav", "wb") as f:
...
if __name__ == '__main__':
    # print(ssmlBuilder("zh-CN", "wangyijiang1", "hello"))
